...
if respuesta == 'paises':
    for i in paises:
        ...
        llamadas_internas_dia1_Venezuela = [len(pais_interno_dia1_7am), len(pais_interno_dia1_8am), len(pais_interno_dia1_9am), len(pais_interno_dia1_10am),
        ...
        rects = plt.bar(Horas,llamadas_internas_dia1_Venezuela, width=0.5)
        ...
        promedio_7am = (len(pais_interno_dia1_7am)+len(pais_interno_dia2_7am)+len(pais_interno_dia3_7am)+len(pais_interno_dia4_7am)+len(pais_interno_dia5_7am)+len(pais_interno_dia6_7am)+len(pais_interno_dia7_7am))/7
        promedio_8am = (len(pais_interno_dia1_8am)+len(pais_interno_dia2_8am)+len(pais_interno_dia3_8am)+len(pais_interno_dia4_8am)+len(pais_interno_dia5_8am)+len(pais_interno_dia6_8am)+len(pais_interno_dia7_8am))/7
        promedio_9am = (len(pais_interno_dia1_9am)+len(pais_interno_dia2_9am)+len(pais_interno_dia3_9am)+len(pais_interno_dia4_9am)+len(pais_interno_dia5_9am)+len(pais_interno_dia6_9am)+len(pais_interno_dia7_9am))/7
        promedio_10am = (len(pais_interno_dia1_10am)+len(pais_interno_dia2_10am)+len(pais_interno_dia3_10am)+len(pais_interno_dia4_10am)+len(pais_interno_dia5_10am)+len(pais_interno_dia6_10am)+len(pais_interno_dia7_10am))/7
        promedio_11am = (len(pais_interno_dia1_11am)+len(pais_interno_dia2_11am)+len(pais_interno_dia3_11am)+len(pais_interno_dia4_11am)+len(pais_interno_dia5_11am)+len(pais_interno_dia6_11am)+len(pais_interno_dia7_11am))/7
        promedio_12pm = (len(pais_interno_dia1_12pm)+len(pais_interno_dia2_12pm)+len(pais_interno_dia3_12pm)+len(pais_interno_dia4_12pm)+len(pais_interno_dia5_12pm)+len(pais_interno_dia6_12pm)+len(pais_interno_dia7_12pm))/7
        promedio_1pm = (len(pais_interno_dia1_1pm)+len(pais_interno_dia2_1pm)+len(pais_interno_dia3_1pm)+len(pais_interno_dia4_1pm)+len(pais_interno_dia5_1pm)+len(pais_interno_dia6_1pm)+len(pais_interno_dia7_1pm))/7
        promedio_2pm = (len(pais_interno_dia1_2pm)+len(pais_interno_dia2_2pm)+len(pais_interno_dia3_2pm)+len(pais_interno_dia4_2pm)+len(pais_interno_dia5_2pm)+len(pais_interno_dia6_2pm)+len(pais_interno_dia7_2pm))/7
        promedio_3pm = (len(pais_interno_dia1_3pm)+len(pais_interno_dia2_3pm)+len(pais_interno_dia3_3pm)+len(pais_interno_dia4_3pm)+len(pais_interno_dia5_3pm)+len(pais_interno_dia6_3pm)+len(pais_interno_dia7_3pm))/7
        promedio_4pm = (len(pais_interno_dia1_4pm)+len(pais_interno_dia2_4pm)+len(pais_interno_dia3_4pm)+len(pais_interno_dia4_4pm)+len(pais_interno_dia5_4pm)+len(pais_interno_dia6_4pm)+len(pais_interno_dia7_4pm))/7
        promedio_5pm = (len(pais_interno_dia1_5pm)+len(pais_interno_dia2_5pm)+len(pais_interno_dia3_5pm)+len(pais_interno_dia4_5pm)+len(pais_interno_dia5_5pm)+len(pais_interno_dia6_5pm)+len(pais_interno_dia7_5pm))/7
        promedio_6pm = (len(pais_interno_dia1_6pm)+len(pais_interno_dia2_6pm)+len(pais_interno_dia3_6pm)+len(pais_interno_dia4_6pm)+len(pais_interno_dia5_6pm)+len(pais_interno_dia6_6pm)+len(pais_interno_dia7_6pm))/7
